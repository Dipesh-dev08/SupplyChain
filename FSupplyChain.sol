...
contract SupplyChain{
    ...
    */
    ...
    /*
    * Store can place order for products to any supplier by providing its address
    */
    ...
    */
    ...
    function getStatus(OrderStatus _status) public pure returns (string memory)
    {
